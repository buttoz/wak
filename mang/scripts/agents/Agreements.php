...
<button type="button" class="btn btn-success" style="padding: 2px 16px;margin: 15px 0;" id="send_agent_marketer_agree">
    שליחת טופס הסכם
</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="Agreementsadd">
                    <input type="hidden" name="agent_id" id="agent_id_agree" value="<? echo $user['c_id'] ?>">
                    <label><?php echo $lang['description']; ?></label><br>
                    <input type="text" class="form-control" id="description_agree" name="description" required><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateagreements">
                    <input type="hidden" name="agent_idtoedit_agree" id="agent_idtoedit_agree" value="<? echo $user['c_id'] ?>">
                    <label><?php echo $lang['description']; ?></label><br>
                    <input type="text" class="form-control" id="descriptiontoedit_agree" name="descriptiontoedit_agree" required><br>
                    <label for="am"><?php echo $lang['upload_agree_doc']; ?></label><br>
