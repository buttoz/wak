                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-footer">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo pathUrl(__DIR__ . '/../../') . 'logout_client  .php' ?>" class="btn btn-default btn-flat"><?php echo $lang['logout'] ?></a>
                        </div>
                    </li>
                </ul>
            </li>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    */ ?>
                    <li class="nav-item <?php echo isset($_GET['action']) && $_GET['action'] == 'one_msg' ? 'menu-is-opening menu-open active' : (isset($_GET['action']) && $_GET['action'] == 'group_msg' ? 'menu-is-opening menu-open active' : (isset($_GET['action']) && $_GET['action'] == 'import_customers' ? 'menu-is-opening menu-open active' : '')) ?>">
                        <a href="#" class="nav-link <?php echo isset($_GET['action']) && $_GET['action'] == 'one_msg' ? 'active' : (isset($_GET['action']) && $_GET['action'] == 'group_msg' ? 'active' : (isset($_GET['action']) && $_GET['action'] == 'import_customers' ? 'active' : '')) ?>">
                        ...
                        <ul class="nav nav-treeview" style="display: none;">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $index_path . '?sec=msg&action=one_msg' ?>" class="nav-link <?php echo $_GET['action'] == 'one_msg' ? "active" : "" ?>">
                                    <i class="fas fa-user-edit nav-icon"></i>
                                    <p> הודעה אחת</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo $index_path . '?sec=msg&action=group_msg' ?>" class="nav-link <?php echo $_GET['action'] == 'group_msg' ? "active" : "" ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $index_path . '?sec=msg&action=import_customers' ?>" class="nav-link <?php echo $_GET['action'] == 'import_customers' ? "active" : "" ?>">
