    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="docadd">
                    <input type="hidden" name="doc_client_id" id="doc_client_id" value="<? echo $_GET['id'] ?>">
...
<div class="modal fade" id="updatedocmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updatedoc">
                    <input type="hidden" name="client_idtoedit_doc" id="client_idtoedit_doc" value="<? echo $_GET['id'] ?>">
                    <label><?php echo $lang['description']; ?></label><br>
                    ...
                    <div id="view_image">
                        <i class="fas fa-search fa-lg view_image_docc"></i>
                    </div>
                    <div class="invbtn">
                        <input class="btn btn-success" type="submit" value="<?php echo $lang['save'] ?>">
