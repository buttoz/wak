    ...
    <div class="modal-dialog" role="checkument">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="checkadd">
                    <input type="hidden" name="check_client_id" id="check_client_id" value="<? echo $_GET['id'] ?>">
...
<div class="modal fade" id="updatecheckmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="checkument">
        <div class="modal-content">
            ...
            <div class="modal-body">    
                <form id="updatecheck">
                    <input type="hidden" name="client_idtoedit_check" id="client_idtoedit_check" value="<? echo $_GET['id'] ?>">
                    <label><?php echo $lang['description']; ?></label><br>
