...
$changelanguage = 1; //$res['setting_value'];
...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="./mang/ui/all.min.css">
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="./mang/ui/icheck-bootstrap.min.css">
  <?php if ($_SESSION['lang'] == 'ar' || $_SESSION['lang'] == 'he') {
  ?>
    <link rel="stylesheet" href="https://cdn.rtlcss.com/bootstrap/v4.5.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="./mang/ui/rtl.css">
  <?php
  } ?>
  <!-- Theme style -->
  <link rel="stylesheet" href="./mang/ui/adminlte.min.css">
...
<body class="hold-transition login-page">
  ...
  <!-- jQuery -->
  <script src="./mang/js/jquery.min.js"></script>
  <!-- Bootstrap 4 -->
  <script src="./mang/js/bootstrap.bundle.min.js"></script>
  <!-- AdminLTE App -->
  <script src="./mang/js/adminlte.min.js"></script>
</body>
